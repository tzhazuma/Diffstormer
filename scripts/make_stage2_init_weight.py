...
parser.add_argument("--cldm_config", type=str, default='/home_data/home/lifeng2023/code/moco/DiffBIR-main/configs/model/cldm.yaml', required=False)
parser.add_argument("--sd_weight", type=str, default='/home_data/home/lifeng2023/code/moco/DiffBIR-main/checkpoints/cldm.ckpt', required=False)
#parser.add_argument("--sd_weight", type=str, default='/home_data/home/lifeng2023/.cache/huggingface/hub/models--laion--CLIP-ViT-H-14-laion2B-s32B-b79K', required=False)
#parser.add_argument("--swinir_weight", type=str, default='/home_data/home/lifeng2023/code/moco/DiffBIR-main/checkpoints/lightning_logs/version_1285486/checkpoints/step=999.ckpt', required=False)
parser.add_argument("--swinir_weight", type=str, default='/public_bme/data/lifeng/code/moco/TS_BHIR/checkpoints/lightning_logs/version_1411889/checkpoints/step=499.ckpt', required=False)
parser.add_argument("--output", type=str, default='/public_bme/data/lifeng/code/moco/TS_BHIR/checkpoints/init_weight_ts.pt', required=False)
